...
#                 q_x, scale_x = Q.symmetric_dynamic_quantize_int8_per_tensor(x, qmin, qmax)
#             case _:
#                 raise ValueError("Invalid input quantization method")
        
#         match w_quantizer:
#             case ('dynamic', 'symmetric', 'tensor'):
#                 q_w, scale_w = Q.symmetric_dynamic_quantize_int8_per_tensor(weight, qmin, qmax)
#             case ('dynamic', 'symmetric', 'channel'):
#                 q_w, scale_w = Q.symmetric_dynamic_quantize_int8_per_channel(weight, qmin, qmax)
#             case _:
...
# class _conv2d_uint8_ste(_conv2d_uint8_base):
#     @staticmethod
