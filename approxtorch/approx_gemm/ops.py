...
def fetch_gemm_custom_grad(index_tensor: Tensor, grad_lut_tensor: Tensor) -> Tensor:
    return torch.ops.approxtorch.fetch_gemm_custom_grad.default(index_tensor, grad_lut_tensor)